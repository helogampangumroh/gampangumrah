            ...
            ->addColumn(
                ...
                function ($user) {
                    ...
                    if ((Sentinel::getUser()->id !== $user->id) && ($user->id > 2)) {
                        $actions .= '<a href='. route('admin.users.confirm-delete', $user->id) .' data-id="'.$user->id.'" data-bs-toggle="modal" data-bs-target="#delete_confirm"><i class="livicon" data-name="user-remove" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete user"></i></a>';
                    }
                    return $actions;
                }
            )
