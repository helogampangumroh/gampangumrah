            ...
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card ">
                    <div class="card-header bg-primary text-white">
                        <span class="float-start my-2">
                            <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                                data-loop="true"></i>
                            Tambah User
                        </span>
                        <a href="{{ URL('admin/bulk_import_users') }}" class="float-end btn btn-success">
                            <i class="fa fa-plus fa-fw"></i>Bulk Import</a>

                    </div>
                    <div class="card-body">
                        <!--main content-->
                        <form id="commentForm" action="{{ route('admin.users.store') }}" method="POST"
                            ...
                            <div id="rootwizard">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a href="#tab1" data-bs-toggle="tab" class="nav-link">User
                                            Profile</a></li>
                                    <li class="nav-item"><a href="#tab2" data-bs-toggle="tab"
                                            class="nav-link ms-2">Bio</a>
                                    </li>
                                    <li class="nav-item"><a href="#tab3" data-bs-toggle="tab"
                                            class="nav-link ms-2">Address</a></li>
                                    <li class="nav-item"><a href="#tab4" data-bs-toggle="tab" class="nav-link ms-2">User
                                            Role</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane " id="tab1">
                                        ...
                                        <div
                                            class="form-group mb-3 {{ $errors->first('password_confirm', 'has-error') }}">
                                            <div class="row">
                                                <label for="password_confirm" class="col-sm-2 form-label">Confirm
                                                    Password *</label>
                                                <div class="col-sm-10">
                                    ...
                                    <div class="tab-pane" id="tab2" disabled="disabled">
                                        <h2 class="hidden">&nbsp;</h2>
                                        <div class="form-group mb-3  {{ $errors->first('dob', 'has-error') }}">
                                            <div class="row">
                                        ...
                                        <div class="form-group mb-3 {{ $errors->first('pic_file', 'has-error') }}">
                                            <div class="row">
                                                <label class="col-sm-2 form-label">Profile picture</label>
                                                <div class="col-sm-10">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        <div
                                                            class="fileinput-preview fileinput-exists thumbnail max-width-height2">
                                                        </div>
                                                        <div>
                                                        </div>
                                                        ...
                                                        <a href="#" class="btn btn-danger fileinput-exists"
                                                            data-bs-dismiss="fileinput">Remove</a>
                                                    </div>
                                                </div>
                                                <span
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="bio" class="col-sm-2 form-label">Bio <small>(brief
                                                        intro) </small></label>
                                                <div class="col-sm-10">
                                                    <textarea name="bio" id="bio" class="form-control resize_vertical h100">{!! old('bio') !!}</textarea>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="tab3" disabled="disabled">
                                        <div class="form-group mb-2 {{ $errors->first('gender', 'has-error') }}">
                                            <div class="row">
                                                <label for="email" class="col-sm-2 form-label">Gender </label>
                                                <div class="col-sm-10">
                                        ...
                                        <div class="form-group mb-2 {{ $errors->first('country', 'has-error') }}">
                                            <div class="row">
                                                ...
                                                <span
                                                    class="help-block">{{ $errors->first('country', ':message') }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input id="state" name="user_state" type="text"
                                                        class="form-control" value="{!! old('user_state') !!}" />
                                                </div>
                                                <span
                                                    class="help-block">{{ $errors->first('user_state', ':message') }}</span>
                                            </div>
                                        </div>
                                        <div class="form-group mb-2">
                                            <div class="row">
                                        ...
                                        <div class="form-group mb-2">
                                            <div class="row">
                                                ...
                                                <span
                                                    class="help-block">{{ $errors->first('address', ':message') }}</span>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="row">
                                                <label for="postal" class="col-sm-2 form-label">Postal/zip</label>
                                                <div class="col-sm-10">
...
<p class="text-danger"><strong>Be careful with role selection, if you give admin
                                        ...
                                        <div class="form-group mb-3" required>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-select" required title="Select role..."
                                                        name="role" id="role">
                                                        <option value="">Select</option>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="activate" class="col-sm-2 form-label"> Activate User
                                                    *</label>
                                                <div class="col-sm-10">
                                                    <input id="activate" name="activate" type="checkbox"
                                                        class="pos-rel p-l-30  form-check-label" value="1"
