...
@section('content')
    ...
    <!--section ends-->
    <section class="content user_profile  ps-3 pe-3">
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav  nav-tabs first_svg">
                    <li class="nav-item">
                        <a href="#tab1" data-bs-toggle="tab" class="nav-link active">
                            <i class="livicon" data-name="user" data-size="16" data-c="#777" data-hc="#000"
                                data-loop="true"></i>
                            User Profile</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content mar-top" id="clothing-nav-content">
                    ...
                    <div id="tab2" class="tab-pane fade">
                        <div class="row">
                            <div class="col-md-12 pd-top ms-auto">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#change-password').click(function(e) {
                ...
                if (check == true) {
                    var sendData = '_token=' + $("input[name='_token']").val() + '&password=' + $(
                        '#password').val() + '&id=' + {{ $user->id }};
